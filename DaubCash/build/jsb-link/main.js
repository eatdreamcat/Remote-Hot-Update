...
window.boot = function () {
    ...
    if (false) {
        ...
        var bundledScript = settings.debug ? 'src/project.dev.js' : 'src/project.dfc5f.js';
        if (jsList) {
...
// main.aed82.js is qqplay and jsb platform entry file, so we must leave platform init code here
if (false) {
