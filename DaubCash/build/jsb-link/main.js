...
window.boot = function () {
    ...
    if (false) {
        ...
        var bundledScript = settings.debug ? 'src/project.dev.js' : 'src/project.3c21e.js';
        if (jsList) {
...
// main.91f12.js is qqplay and jsb platform entry file, so we must leave platform init code here
if (false) {
