...
window.boot = function () {
    ...
    if (false) {
        ...
        var bundledScript = settings.debug ? 'src/project.dev.js' : 'src/project.e02ba.js';
        if (jsList) {
...
// main.1830c.js is qqplay and jsb platform entry file, so we must leave platform init code here
if (false) {
