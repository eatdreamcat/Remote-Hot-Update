...
window.boot = function () {
    ...
    if (false) {
        ...
        var bundledScript = settings.debug ? 'src/project.dev.js' : 'src/project.385a6.js';
        if (jsList) {
...
// main.8853c.js is qqplay and jsb platform entry file, so we must leave platform init code here
if (false) {
    ...
    if (isRuntime) {
        require('src/settings.116ee.js');
        require('src/cocos2d-runtime.js');
        require('jsb-adapter/engine/index.js');
    }
    else {
        require('src/settings.116ee.js');
        require('src/cocos2d-jsb.2b130.js');
