...
window.boot = function () {
    ...
    if (false) {
        ...
        var bundledScript = settings.debug ? 'src/project.dev.js' : 'src/project.68219.js';
        if (jsList) {
...
// main.dfa3b.js is qqplay and jsb platform entry file, so we must leave platform init code here
if (false) {
