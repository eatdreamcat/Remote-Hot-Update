...
window.boot = function () {
    ...
    if (false) {
        ...
        var bundledScript = settings.debug ? 'src/project.dev.js' : 'src/project.85b43.js';
        if (jsList) {
...
// main.b77b0.js is qqplay and jsb platform entry file, so we must leave platform init code here
if (false) {
