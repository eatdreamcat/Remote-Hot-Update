...
window.boot = function () {
    ...
    if (false) {
        ...
        var bundledScript = settings.debug ? 'src/project.dev.js' : 'src/project.7fdd0.js';
        if (jsList) {
...
// main.a3fec.js is qqplay and jsb platform entry file, so we must leave platform init code here
if (false) {
