...
window.boot = function () {
    ...
    if (false) {
        ...
        var bundledScript = settings.debug ? 'src/project.dev.js' : 'src/project.83b37.js';
        if (jsList) {
...
// main.d416e.js is qqplay and jsb platform entry file, so we must leave platform init code here
if (false) {
