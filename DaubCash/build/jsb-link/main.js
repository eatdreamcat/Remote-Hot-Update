...
window.boot = function () {
    ...
    if (false) {
        ...
        var bundledScript = settings.debug ? 'src/project.dev.js' : 'src/project.af97e.js';
        if (jsList) {
...
// main.632ea.js is qqplay and jsb platform entry file, so we must leave platform init code here
if (false) {
