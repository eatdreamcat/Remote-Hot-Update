...
window.boot = function () {
    ...
    if (false) {
        ...
        var bundledScript = settings.debug ? 'src/project.dev.js' : 'src/project.1bc22.js';
        if (jsList) {
...
// main.1942f.js is qqplay and jsb platform entry file, so we must leave platform init code here
if (false) {
